...
import { startGetUserDetails, startRemoveUser, startSearch } from "../actions/userAction";
  ...
  return (
    <div className="container mt-5">
     ...
     {Object.keys(val).length>0 ? (
        <div>
        <input type="text" value={search} onChange={handleSearch} placeholder="Search Name" />
